...
on("sheet:compendium-drop", (eventInfo) => {	
	...
	const default_values_token={};
	default_values_token["bar1_link"]= 'sanity_points',
	default_values_token["bar2_link"]= 'willpower_points',
	default_values_token["bar3_link"]= 'hit_points',
	default_values_token["bar1_value"]= 1,
	default_values_token["bar2_value"]= 2,
	default_values_token["bar3_value"]= 3,
	console.info('default values:',default_values_token);
